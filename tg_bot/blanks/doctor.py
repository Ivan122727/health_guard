...
class DoctorBlank(CommonBlank):
    ...
    @staticmethod
    def get_set_times_per_day_blank(count: int) -> str:
        """Бланк ввода времени для каждого опроса"""
        time_examples = {
            1: ["09:00"],
            2: ["09:00", "19:00"],
            3: ["08:00", "13:00", "18:00"],
    ...
    @staticmethod
    def get_once_per_day_blank() -> str:
        """Бланк настройки ежедневного опроса"""
        return (
    ...
    @staticmethod
    def get_every_few_days_time_blank(days: int) -> str:
        """Бланк ввода времени для опроса раз в несколько дней"""
